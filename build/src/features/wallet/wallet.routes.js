...
const wallet_middleware_1 = require("./wallet.middleware");
...
router
    .route("/bank-account")
    .post(auth_user_middleware_1.isUserAuthenticated, wallet_middleware_1.bankAccountResolveLimiter, (0, app_validate_1.default)(wallet_validator_1.resolveBankAccountValidator), controller_module_1.walletController.getBankAccountDetails);
// Transfer to Bank (NGN)
router
    .route("/transfer-to-bank")
    .post(auth_user_middleware_1.isUserAuthenticated, (0, app_validate_1.default)(wallet_validator_1.transferToBankValidator), controller_module_1.walletController.transferToBank);

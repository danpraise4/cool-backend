...
router.route("/").get(auth_user_middleware_1.isUserAuthenticated, controller_module_1.materialsController.getAllMaterials);
router.route("/:id").get(auth_user_middleware_1.isUserAuthenticated, (0, app_validate_1.default)(materials_validator_1.getMaterialsValidator), controller_module_1.materialsController.getMaterialsById);
